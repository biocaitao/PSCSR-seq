...
#load("pbmc.dat")
pbmc.data <- Read10X(data.dir = "PBMC2/outs/filtered_feature_bc_matrix/")
...
#pbmc <- ScaleData(object = pbmc, features = VariableFeatures(pbmc), vars.to.regress = c("nCount_RNA"))
pbmc <- ScaleData(pbmc)
